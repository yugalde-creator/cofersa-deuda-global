...
function parseMonto(s) {
  ...
  // Nota: el grupo inicial usa \d+ (no \d{1,3}) para no fallar con enteros de
  // 4+ dígitos sin separador de miles, ej. "1223,94" (bug histórico: esos
  // casos caían al parseFloat() plano de abajo y truncaban los decimales).
